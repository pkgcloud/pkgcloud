    ...
    if (process.env.NOCK) {
      if (provider === 'joyent') {
        ...
        nock('http://compute.myownendpoint.org:8774')
          ...
          .post('/v2/72e90ecb69c44d0296072ea39e537041/servers', "{\"server\":{\"name\":\"create-test-setWait\",\"flavorRef\":1,\"imageRef\":\"506d077e-66bf-44ff-907a-588c5c79fa66\",\"personality\":[]}}")
