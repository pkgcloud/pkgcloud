...
function createServer(options, callback) {
  ...
  self.deploy(templateName, options, adjustVMTemplate, (err, result) => {
    return err ?
      callback(err) :
...
function addDataDiskToVM(vm, size, storageAccountName, callback) {
  console.log('Adding DataDisk to Virtual Machine: ' + vm);
  this.computeClient.virtualMachines.get(this.resourceGroupName, vm, function (error, machine_info){
