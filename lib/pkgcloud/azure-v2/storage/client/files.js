...
exports.removeFile = function (container, file, options, callback) {
  ...
  this.getBlobService(azureContainerName, containerName, (err, blobService) => {
...
exports.getFiles = function (container, options, callback) {
  ...
  self.getBlobService(azureContainer, containerName, (err, blobService) => {
    ...
    blobService.listBlobsSegmented(azureContainer, null, function(err, result) {
      aggregateBlobs(err, result, (err, blobs) => {
        return err ?
          callback(err) :
          callback(null, blobs.map(blob => new self.models.File(self, blob)));
      });
    });
...
exports.getFile = function (container, file, options, callback) {
  ...
  self.getBlobService(azureContainerName, containerName, (err, blobService) => {
