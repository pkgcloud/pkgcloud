  ...
  function handleRequest(err, res, body) {
    ...
    if (Object.keys(self.failCodes).indexOf(statusCode) !== -1) {
      ...
      err2 = {
        ...
        // TODO: we lose the status code. Should not have to parse an error string to get it. Some errors are okay
        // provide the status code so we can recover in the context of the type of request
