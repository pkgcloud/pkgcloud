...
exports.getFlavors = function getFlavors(callback) {
  ...
  callback(null, Object.keys(compute.Flavor.options).map(function (id) {
    return new compute.Flavor(self, { id: id });
  }));
};
...
exports.getFlavor = function getFlavor(flavor, callback) {
  ...
  if (flavor instanceof base.Flavor) return callback(null, flavor);
