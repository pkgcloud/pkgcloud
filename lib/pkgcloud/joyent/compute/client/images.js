...
exports.getImages = function getImages(callback) {
  var self = this;
  return this.request(this.account + '/datasets', callback, function (body, res) { 
...
exports.getImage = function getImage(image, callback) {
  ...
  return this.request(this.account + '/datasets/' + imageId, callback, 
    function (body, res) { callback(null, new compute.Image(self, body), res);
  });
};
