...
exports.getVersion = function getVersion(callback) {
  return this.request(this.config.account + '/datacenters', callback,
    function (_, response) {
      callback(null, response.headers['x-api-version']);
  });
};
...
exports.getServer = function getServer(server, callback) {
  ...
  return this.request(this.config.account + '/machines/' + serverId, callback,
    function (body) { callback(null, new compute.Server(self, body));
  });
};
