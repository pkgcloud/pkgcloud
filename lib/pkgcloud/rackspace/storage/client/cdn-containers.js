...
exports.getCdnContainers = function (options, callback) {
  ...
  this._request(getContainerOpts, function (err, body) {
    return err
      ...
      container.staticWebsiteIndexPage = container.static_website_index_page;
...
exports._getCdnContainerDetails = function(container, callback) {
  ...
  this._request({
    ...
    container.staticWebsiteIndexPage = res.headers['x-container-meta-web-index'];
 ...
 *
 * @description set the stitc website index page on a storage container
 *
 * @param {String|object}     container     the container or containerName
...
exports.setStaticWebsiteIndexPage = function (container, options, callback) {
  ...
  var staticWebsiteOpts = {
    method: 'POST',
    container: containerName,
    serviceType: this.cdnServiceType,
    headers: {
      'x-container-meta-web-index': indexFile
    }
  };

  self._request(staticWebsiteOpts, function(err) {
    if (err) {
      return callback(err);
    }
