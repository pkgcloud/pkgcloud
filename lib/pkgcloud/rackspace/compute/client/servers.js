...
exports.getVersion = function getVersions(callback) {
  return request.get('https://' + this.serversUrl, function (err, res, body) {
    try { callback(null, JSON.parse(body).versions[0].id); }
...
exports.getLimits = function (callback) {
  return this.request('limits', callback, function (body) {
    callback(null, body.limits);
  });
};
...
exports.getServers = function getServers(callback) {
  var self = this;
  return this.request('servers/detail.json', callback, function (body) {
...
exports.createServer = function createServer(options, callback) {
  ...
  createOptions.body.server.personality = 
    options.personality || [];
  return this.request(createOptions, callback, function (body, response) {
    callback(null, new compute.Server(self, body.server));
  });
};
...
exports.destroyServer = function destroyServer(server, callback) {
  ...
  return this.request(destroyOptions, callback, function (body, response) {
    callback(null, {ok: serverId}, response);
  });
};
...
exports.getServer = function getServer(server, callback) {
  ...
  return this.request('servers/' + serverId, callback, function (body) {
    callback(null, new compute.Server(self, body.server));
  });
};
...
exports.getServerBackup = function (server, callback) {
  ...
  this.request(backupOptions, callback, function (body) {
    callback(null, body.backupSchedule);
  });  
};
