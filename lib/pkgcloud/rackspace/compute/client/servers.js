...
exports.getVersion = function getVersions(callback) {
  return request.get(this.protocol + this.serversUrl, function (err, res, body) {
    try {
...
//
// #### @callback {function} f(err, limits).
//
...
// ####    @name     {String} **Required** a name for your server
// ####    @flavor   {String|Favor} **Required** flavor to use for this image
// ####    @image    {String|Image} **Required** the image to use
