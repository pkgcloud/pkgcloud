...
exports.getImage = function getImage(image, callback) {
  ...
  this.request('images/' + imageId, callback, function (body) {
...
exports.createImage = function createImage(options, callback) {
  ...
  this.request({ method: 'POST', path: 'images',
    body: {
      image: {
        name: options.name,
        serverId: serverId
...
exports.destroyImage = function destroyImage(image, callback) {
  ...
  this.request({ method: 'DELETE', path: 'images/' + imageId }, callback,
    function () { callback(null, {"ok": imageId});
  });
};