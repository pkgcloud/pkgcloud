...
exports.getFlavors = function getFlavors(callback) {
  var self = this;
  return this.request('flavors/detail.json', callback, function (body) {
...
exports.getFlavor = function getFlavor(flavor, callback) {
  ...
  return this.request('flavors/' + flavorId, callback, function (body) {
    callback(null, new compute.Flavor(self, body.flavor));
  });
};