...
// ### @options {Object|Array} Set of options can be
...
exports.createUser = function createUser (options, callback) {
  ...
  function makeRequest () {
    ...
    self.request(createOptions, callback, function (body, response) {
