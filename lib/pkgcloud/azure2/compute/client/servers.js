...
exports.getServer = function getServer(server, callback) {
  ...
  azureApi.getServer(this, serverId, callback, function(body, server) {
...
exports.createServer = function createServer(options, callback) {
  ...
  azureApi.createServer(this, options, callback, function(body, server) {
    callback(null, new compute.Server(self, server), res);
  });
};
...
exports.destroyServer = function destroyServer(server, callback) {
  ...
  azureApi.destroyServer(this, serverId, callback, function(body, res) {
...
exports.stopServer = function stopServer(server, callback) {
  ...
  azureApi.stopServer(this, serverId, callback, function(body, res) {
    callback(null, { ok: serverId }, res);
  });
};
...
exports.rebootServer = function rebootServer(server, callback) {
  ...
  azureApi.rebootServer(this, serverId, callback, function(body, res) {
    callback(null, { ok: serverId }, res);
  });
};
