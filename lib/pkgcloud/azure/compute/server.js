...
Server.prototype._setProperties = function (details) {
  ...
  // azure returns very inconsistent RoleInstance status so we check everything.
  ...
  // READYROLE.
  // Note: since we have to wait until azure responds to our createdDeployment request, we most likely will miss all of the
  // deployment states.
