/*
 * azureServer.js: Azure VM implementation.
 *
...
AzureServer.prototype.createServer = function(options, next) {
  ...
  async.waterfall([
    ...
    function(callback) {
      ...
      self.getOSImage(self.options.image, callback);
    },
    function(callback){
...
AzureServer.prototype.addCertificate = function(serviceName, data, password, callback) {
  ...
  this.serviceManager.addCertificate(serviceName, data, 'pfx', password, function(err, result) {
    if(err) {
      callback(err);
    } else {
      callback(null);
...
AzureServer.prototype.createWindowsVM = function(callback) {
  var self = this,
    vmName = this.options.name.slice(0, 15);
