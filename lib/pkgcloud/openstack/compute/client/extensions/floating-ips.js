 ...
 * @param {String}          fixedAddress    The fixed address
 * @param {function}        callback
 * @returns {*}
 */
exports.addFloatingIp = function (server, floatingIp, fixedAddress, callback) {
  if (typeof fixedAddress === 'function') {
    callback = fixedAddress;
    fixedAddress = null;
  }
