/*
 * os-floating-ips.js: OpenStack Floating IP Extension
 *
 * (C) 2013 Rackspace
 *      Ken Perkins
 * MIT LICENSE
 ...
 *
 * @param {String}          [pool]      The optional pool of IPs to allocate from
 * @param {function}        callback
 * @returns {*}
 */
 ...
 * @param {String|Object}   floatingIp      The floatingIp ID or object
 * @param {function}        callback
 * @returns {*}
 */
