 ...
 * @param {Object}          [details.userData]   optional userData configuration (for clound-base-init)
 * @param callback
 * @returns {request|*}
 */
exports.createServer = function createServer(details, callback) {
  ...
  if (details.userData) {
      createOptions.body.server.user_data = new Buffer(details.userData).toString('base64');
  }
