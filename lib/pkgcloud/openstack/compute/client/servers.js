 ...
 * @param {String|object}   options.flavor       The flavor or flavorId to use in the rebuild
...
exports.rebuildServer = function rebootServer(server, options, callback) {
  var imageId, flavorId, rebuildBody = {};
  if (options instanceof base.Image) {
    ...
    rebuildBody.flavorRef = options.flavor instanceof base.Flavor ? options.flavor.id : options.flavor;
  } else {
