 ...
 * @param {String}          details.availability_zone  the availability zone to create the server in
 ...
 * @param {Object}          [details.cloudConfig] optional user_data
 * @param {Object}          [details.metadata]    optional metadata configuration
 * @param {Object}          [details.securityGroups]    optional security groups to add to the server
 * @param callback
 * @returns {request|*}
 */
