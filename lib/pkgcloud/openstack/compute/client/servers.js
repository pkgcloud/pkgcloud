...
exports.createServer = function createServer(details, callback) {
  ...
  if (details.volumes) {
    createOptions.body.server.block_device_mapping_v2 = details.volumes; 
  }
 ...
 * @returns {*}
 */
exports.rebuildServer = function rebuildServer(server, options, callback) {
  var rebuildBody = {};
 ...
 * @returns {*}
 */
exports.resizeServer = function resizeServer(server, flavor, callback) {
...
/**
 * client.addInstanceSecurityGroup
 *
 * @description add a security group to an instance
 *
 * @param {String|object}   server      The server or serverId
 * @param {String}          groupName   The name of security group to add
 * @param {Function}        callback
 * @returns {*}
 */
exports.addInstanceSecurityGroup = function addInstanceSecurityGroup(server, groupName, callback) {
  var options = {
    name: groupName
  };
  return this._doServerAction.call(this, server, { addSecurityGroup: options }, callback);
};

/**
 * client.removeInstanceSecurityGroup
 *
 * @description remove a security group from an instance
 *
 * @param {String|object}   server      The server or serverId
 * @param {String}          groupName   The name of security group to remove
 * @param {Function}        callback
 * @returns {*}
 */
exports.removeInstanceSecurityGroup = function removeInstanceSecurityGroup(server, groupName, callback) {
  var options = {
    name: groupName
  };
  return this._doServerAction.call(this, server, { removeSecurityGroup: options }, callback);
};
