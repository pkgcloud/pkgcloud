 ...
 * @param {function}        body      The body of the server action to perform
 * @returns {*}
 */
...
exports.rebootServer = function rebootServer(server, options, callback) {
  ...
  var serverId = server instanceof base.Server ? server.id : server;
  return this._doServerAction.call(this, serverId, { 'reboot': options }, callback);
};
...
exports.confirmServerResize = function (server, callback) {
  var serverId = server instanceof base.Server ? server.id : server;
  this._doServerAction.call(this, serverId, { 'confirmResize': null }, callback);
};

exports.revertServerResize = function (server, callback) {
  var serverId = server instanceof base.Server ? server.id : server;
  this._doServerAction.call(this, serverId, { 'revertResize': null }, callback);
};
...
exports.rebuildServer = function (server, image, callback) {
  ...
  this._doServerAction.call(this, serverId, { 'rebuild': { 'imageId': imageId } }, callback);
};
