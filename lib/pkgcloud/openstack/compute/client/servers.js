...
exports._doServerAction = function(server, body, callback) {
  ...
  return self.request(actionOptions, function (err) {
    return callback(err);
  });
};
...
exports.getServers = function getServers(options, callback) {
  ...
  return this.request(requestOptions, function (err, body) {
    if (err) {
      return callback(err);
    }
...
exports.createServer = function createServer(details, callback) {
  ...
  if (details.networks) {
    createOptions.body.networks = details.networks;
  }
  ...
  return this.request(createOptions, function (err, body) {
    if (err) {
      return callback(err);
    }
