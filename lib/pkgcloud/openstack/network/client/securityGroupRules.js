...
exports.getSecurityGroupRules = function (options, callback) {
  ...
  this._request(getSecurityGroupRuleOpts, function (err, body) {
    ...
    return callback(null, body.security_group_rules.map(function (securityGroupRule) {
...
exports.getSecurityGroupRule = function (securityGroupRule, callback) {
  var securityGroupRuleId = securityGroupRule instanceof this.models.SecurityGroupRule ? securityGroupRule.id : securityGroupRule,
    self = this;
  ...
  this._request({
    ...
    callback(null, new self.models.SecurityGroupRule(self, body.security_group_rule));
  });
};
 ...
 * @param {int}       securityGroupRule.portRangeMin    The minimum port number in the range that is matched by the security group rule.
 * @param {int}       securityGroupRule.portRangeMax    The maximum port number in the range that is matched by the security group rule.
...
exports.createSecurityGroupRule = function (securityGroupRule, callback) {
  ...
  this._request(createSecurityGroupRuleOpts, function (err,body) {
    return err
      ? callback(err)
      : callback(null, new self.models.SecurityGroupRule(self, body.securityGroupRule));
  });
};
...
exports.destroySecurityGroupRule = function (securityGroupRule, callback) {
  ...
  this._request({
    ...
    callback(null, securityGroupRuleId);
  });
};
