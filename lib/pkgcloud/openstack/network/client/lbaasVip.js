...
var _convertVIPcreateToWireFormat,
    _convertVIPupdateToWireFormat;
...
exports.createVip = function (options, callback) {
  ...
  var vip_create = _convertVIPcreateToWireFormat(vip);
...
exports.updateVip = function (options, callback) {
  ...
  var vip_update = _convertVIPupdateToWireFormat(vip);
...
_convertVIPupdateToWireFormat = function (details){
  ...
  if (typeof details.adminStateUp != 'undefined') {
