...
var lbaasLoadbalancersPath = '/lbaas/loadbalancers';
  ...
  this._request(getlbaasOpts, function (err, body) {
    ...
    return err
      ...
      : callback(err, body.loadbalancers.map(function (lbs) {
          return new self.models.lbaasLoadbalancers(self, lbs);
        }));
  });
};
...
exports.getLoadbalancer = function (option, callback) {
  var self = this,
    loadbalancerID = option instanceof this.models.lbaasLoadbalancers ? option.id : option;
  self.emit('log::trace', 'Getting details for lbaas loadbalancer', loadbalancerID);
  this._request({
    path: urlJoin(lbaasLoadbalancersPath, loadbalancerID),
    method: 'GET'
  }, function (err, body) {
    ...
    return err
      ? callback(err)
      : callback(err, new self.models.lbaasLoadbalancers(self, body.loadbalancer));
  });
};
...
exports.updateLoadbalancer = function (options, callback) {
  ...
  self.emit('log::trace', 'Updating lbaas pools', loadbalancerID);
...
exports.destroyLoadbalancer = function (options, callback) {
  var self = this,
    loadbalancerID = options instanceof this.models.lbaasLoadbalancers ? options.id : options;
