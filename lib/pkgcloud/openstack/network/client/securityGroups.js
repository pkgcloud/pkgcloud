...
exports.getSecurityGroups = function (options, callback) {
  ...
  this._request(getSecurityGroupOpts, function (err, body) {
    ...
    return callback(null, body.security_groups.map(function (securityGroup) {
...
exports.getSecurityGroup = function (securityGroup, callback) {
  var securityGroupId = securityGroup instanceof this.models.SecurityGroup ? securityGroup.id : securityGroup,
    self = this;
  ...
  this._request({
    ...
    callback(null, new self.models.SecurityGroup(self, body.security_group));
  });
};
...
exports.createSecurityGroup = function (securityGroup, callback) {
  ...
  this._request(createSecurityGroupOpts, function (err,body) {
    return err
      ? callback(err)
      : callback(null, new self.models.SecurityGroup(self, body.securityGroup));
  });
};
