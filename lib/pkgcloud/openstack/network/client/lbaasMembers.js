...
var _convertMembercreateToWireFormat,
    _convertMemberupdateToWireFormat;
...
exports.createMember = function (options, callback) {
  ...
  var member_create = _convertMembercreateToWireFormat(member);
...
exports.updateMember = function (options, callback) {
  ...
  var member_update = _convertMemberupdateToWireFormat(member);
