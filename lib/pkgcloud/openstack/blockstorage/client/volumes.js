 ...
 * @param {String}      [options.sourceVolid]  the volume id to use in creating the new volume
 * @param {String}      [options.imageRef]     the image id to use in creating the new volume
...
exports.createVolume = function (options, callback) {
  ...
  else if (options.sourceVolid) {
    createOptions.body.volume['source_volid'] = options.sourceVolid;
  }
  else if (options.imageRef) {
