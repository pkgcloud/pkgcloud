...
exports.getFiles = function (container, options, callback) {
  ...
  // If any options were given, just get a partial set of values
  if (options.limit || options.marker) {
    return this._getFiles(container, options, callback);
  }

  // If no options were given, retrieve all files
  var files = [];
  ...
  var getFilesCallback = function(err, someFiles) {
    ...
    // openstack will return at most 10000 files at once
    if (someFiles.length >= 10000) {
