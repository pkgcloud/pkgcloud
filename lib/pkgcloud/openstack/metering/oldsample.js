...
oldSample.prototype.toJSON = function () {
    return _.pick(this, ['counter_name', 'counter_type', 'counter_unit', 'counter_volume', 'message_id', 'project_id', 'recorded_at', 'resource_id', 'resource_metadata', 'timestamp', 'user_id']);
};
