...
Alarm.prototype.toJSON = function () {
    return _.pick(this, ['alarm_id', 'name', 'project_id', 'user_id', 'alarm_actions', 'type', 'ok_actions', 'timestamp', 'description', 'time_constraints', 'enabled', 'state_timestamp', 'threshold_rule', 'state', 'insufficient_data_action', 'repeat_actions', 'serverity']);
};
