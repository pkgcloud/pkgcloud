...
exports.createStack = function (details, callback) {
  ...
  var self = this,
    createOptions = {
      ...
      body: {
        ...
        environment: details.environment ? details.environment : {},
  ...
  if (details.stackData) {
    ...
    if (details.stackData.parameters) {
      createOptions.body.environment.parameters = details.stackData.parameters;
    }
  }

  // stringify this as the API for openstack requires a string for environment, not an object
  createOptions.body.environment = JSON.stringify(createOptions.body.environment);
