...
// ### @name {String} Username for list their databases
exports.getDatabases = function getDatabases (name, callback) {
  // Check for options
  if (typeof name === 'function') {
    return errs.handle(errs.create({
      message: 'Name required for delete an account.'
  ...
  this.request({ path:'accounts/' + name + '/databases' }, callback, function (body, response) {
