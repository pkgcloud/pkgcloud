...
//
['storage', 'cdn', 'providers', 'database', 'dns', 'blockstorage', 'loadbalancer'].forEach(function (key) {
  pkgcloud[key] = {};
});
...
//
['compute', 'storage', 'cdn', 'database', 'dns', 'blockstorage', 'loadbalancer'].forEach(function (service) {
...
['azure', 'amazon', 'rackspace',
 ...
 'mongohq', 'redistogo', 'openstack',
 'telefonica', 'digitalocean'].forEach(function (provider) {
